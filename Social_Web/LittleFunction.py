...
class action:
    ...
    def setup(self):
        ...
        #self.driver = webdriver.Firefox(executable_path=r'/Users/iris/Desktop/selenium-java-3/geckodriver-v0.16.1')
        self.driver = webdriver.Chrome(executable_path=r'/Users/huweiting/Desktop/auto_test/automation/Social_Web/chromedriver_2_29')
    ...
    def get_verify_code(self,email):
        ...
        self.sleep(3) #不 sleep 三秒就會取不到 resault
    ...
    def login(self):
        ...
        print('click-after')
        self.waitElement(8,(By.CSS_SELECTOR,'body > div:nth-child(30) > div > div.theme__dialog___3pej6.styles__dialog___3pFYp.theme__normal___1Fuy1.theme__active___2gTq9.styles__system-dialog___1c3wz > section'))
        ...
        WebDriverWait(self.driver, 3).until(EC.element_to_be_clickable((By.CSS_SELECTOR,'button.theme__button___Ewr9O:nth-child(8)')))
    ...
    def postText(self):
        ...
        self.driver.find_element_by_name('content').send_keys('[AutoTest]\n測試訊息'+datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
    ...
    def postPhoto(self):
        ...
        self.driver.find_element_by_xpath('(//input[@type="file"])[2]').send_keys(u'/Users/iris/Desktop/測試資料/pic/71.jpg')
    ...
    def postVideo(self):
        ...
        self.driver.find_element_by_xpath('(//input[@type="file"])[1]').send_keys('/Users/iris/Desktop/測試資料/影片/安心亞《別再撐了》官方完整版Official Music Video.mp4')

        self.waitUntilInvisibility(70,(By.XPATH,'//*[@id="toolbox-content"]/div/div/div[2]/div[2]/div/ul/div/div[1]/form/div/div[3]/div/div/div/div/div[2]'))
